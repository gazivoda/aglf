...
export class NGXToastrService {
  ...
  // Success Type
  infoPlayersNumberZero() {
    this.toastr.info(' You need to select minimum 11 players to start playing game!', 'Hint', {
      "timeOut": 5000,
      "progressBar": true,
  ...
  infoPlayersNumberMoreThenZero() {
    this.toastr.info(' You need to select more players to reach minimum  of 11 players to start playing game!', 'Hint', {
      "timeOut": 5000,
      "progressBar": true,
      "messageClass": 'toast-text'
    });
